...
def get_employees(academic_unit: str) -> List[Person]:
    ...
    return [
        Person(id=eid_map.get("10001", "10001"), first_name="Alan", last_name="Turing", middle_initial="M", email="alan@berkeley.edu", role="Faculty"),
        Person(id=eid_map.get("10002", "10002"), first_name="Grace", last_name="Hopper", middle_initial="B", email="grace@berkeley.edu", role="Staff"),
    ]
